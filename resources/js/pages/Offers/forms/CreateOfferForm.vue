...
import { Offer, offerCreateSchema } from '../dtos/data';
...
const onSubmit = form.handleSubmit(async (values) => {
    ...
    saveRecord('/offers', values, true, updatedRecordId.value,
    ...
    <form @submit="onSubmit" class="space-y-4">
        <FormField name="name" v-slot="{ componentField }">
            <FormItem>
                ...
                <FormControl>
                    <Input type="text" placeholder="Enter Offer name" v-bind="componentField" />
                </FormControl>
                <FormMessage />
            </FormItem>
        </FormField>
        ...
        <FormField name="description" v-slot="{ componentField }">
            <FormItem>
                ...
                <FormControl>
                    <Textarea placeholder="Enter Offer description" v-bind="componentField" />
                </FormControl>
                <FormMessage />
            </FormItem>
        </FormField>
            ...
            <FormItem>
                ...
                <FormControl>
                    <FileUploaderInput v-bind="componentField" :existing-image-url="props.record?.image"
                        :max-size-m-b="5" accept="image/*" label="Offer Image"
                        description="Upload a high-quality image for your offer (Max 5MB)" :disabled="isSubmitting" />
                </FormControl>
                <FormMessage />
            </FormItem>
        </FormField>
